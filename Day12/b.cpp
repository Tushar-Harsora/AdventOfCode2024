...
size_t get_linelen(const char *);

struct reg_info get_reg_info(size_t x, size_t y, char id);

long long int calculate_corners(size_t x, size_t y, char id);
